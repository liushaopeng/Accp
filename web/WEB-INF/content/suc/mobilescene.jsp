...
function upd(id){
   var submitData = {
	...
	$.post('${ctx}/suc/mobilescene!upd.action', submitData, function(json) {
		$('#_id').val(json._id);
...
<section>
  ...
  <div class="mainpanel">
	...
	<form  id="custinfoForm" name="custinfoForm" method="post"  action="${contextPath}/Acc_Manage/suc/mobilescene.action" >
      ...
      <div class="breadcrumb-wrapper1 " >
        <div class="input-group pull-right ">
            ...
            <ul class="dropdown-menu pull-right" role="menu">
            	...
            	<li><a href="${contextPath}/Acc_Manage/suc/mobilescene!getAll.action"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;&nbsp;模板库</a></li> 
                        ...
                        <td class="table-action">
                              ...
                              <div class="btn-group1 position-r">
                                  ...
                                  <ul role="menu" class="dropdown-menu pull-right">
                                      <li><a href="${ctx}/suc/mobilescene!create.action?id=${bean._id}">
                                      		<i class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;修改</a></li> 
                                      <li><a href="${ctx}/suc/mobilescene!input.action?msid=${bean._id}">
                                      		<i class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;编辑</a></li> 
                                      <li><a href="${ctx}/suc/roll.action?type=scene${bean._id}">
                                      		<i class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;管理滚动字幕</a></li> 
                                      <li><a href="${ctx}/suc/slide.action?type=scene${bean._id}">
                                      		<i class="fa fa-pencil "></i>&nbsp;&nbsp;&nbsp;&nbsp;管理幻灯片</a></li> 
                                      <li><a href="javascript:del('${bean._id}');">
                                      		<i class="fa fa-trash-o "></i>&nbsp;&nbsp;&nbsp;&nbsp;删除</a></li>
                                      <li><a href="javascript:qrcode('http://www.wbaishui.com/Acc_Manage/suc/mobilescene!web.action?custid=${custid}&msid=${bean._id}')">
