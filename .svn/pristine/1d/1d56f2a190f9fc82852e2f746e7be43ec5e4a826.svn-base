...
<script type="text/javascript" src="${ctx}/css_js/js/jquery.qrcode.js"></script>
<script type="text/javascript" src="${ctx}/css_js/js/qrcode.js"></script> 
<script type="text/javascript">
    ...
    function getwxurl(url){ 
     ...
     $.post('${ctx}/wenxin/wxpay!getwxurl.action', submitData, function(json) {
       if(json.state==0){  
