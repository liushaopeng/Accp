										...
										<div class="thmb">
										   ...
										   <div class="btn-group fm-group">
												...
												<ul class="dropdown-menu fm-menu" role="menu">
													<li><a href="${contextPath}/Acc_Manage/suc/mobilescene!web.action?custid=${bean.custid}&msid=${bean._id}&fromUser=oypimjo3Ln36uWtmW6TYWtND0P0o" target="_blank"><i
															class="fa fa-share"></i>预览</a></li>
													
													<li><a href="${contextPath}/Acc_Manage/suc/mobilescene!copyScene.action?msid=${bean._id}"><i
