 ...
 */
@Namespace("/suc")
@Results( { @Result(name ="reload", location = "image.action",params={"fypage","%{fypage}","type","%{type}","width","%{width}","height","%{height}"}, type = "redirect") })
public class ImageAction extends TotalAction<ImageInfo>{
